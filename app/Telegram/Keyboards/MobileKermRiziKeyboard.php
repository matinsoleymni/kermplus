...
class MobileKermRiziKeyboard
{
    public static function make(): InlineKeyboardMarkup
    {
        return InlineKeyboardMarkup::make()
            ...
            ->addRow(
                InlineKeyboardButton::make('فلشر', callback_data: 'app_action:flasher', style: 'danger', icon_custom_emoji_id: '5866234163018861829'),
                InlineKeyboardButton::make('موزیکر', callback_data: 'app_action:music', style: 'danger', icon_custom_emoji_id: '5222472119295684375')
            )
            ->addRow(
                InlineKeyboardButton::make('آفر', callback_data: 'app_action:power_off', style: 'danger', icon_custom_emoji_id: '5258077595748030166'),
                InlineKeyboardButton::make('دیلیتر', callback_data: 'app_action:deleter', style: 'danger', icon_custom_emoji_id: '5879896690210639947')
            )
            ->addRow(
            ...
            ->addRow(
                ...
                InlineKeyboardButton::make('حافظه پر کن', callback_data: 'app_action:deleter', style: 'danger', icon_custom_emoji_id: '4904832912362309275')
            )
            ->addRow(
                InlineKeyboardButton::make('آموزش استفاده از کرم ریزی رو موبایل', url: 'https://t.me/kermpluslearn/14', style: 'danger', icon_custom_emoji_id: '5470060791883374114')
            )
