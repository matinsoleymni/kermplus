...
class RubikaReporterConversation extends BaseReporterConversation
{
    ...
    public function awaitUsername(Nutgram $bot)
    {
        ...
        $details = "<tg-emoji emoji-id='4929619512224909015'>🪱</tg-emoji> KermPlus | Target Ready\n" .
            "━━━━━━━━━━━━━━━\n" .
            "<tg-emoji emoji-id='5350460637182993292'>🎯</tg-emoji> نوع هدف: {$targetLabel}\n" .
            "<tg-emoji emoji-id='4913497231492908158'>👤</tg-emoji> یوزرنیم: @{$username}\n" .
            "━━━━━━━━━━━━━━━\n\n" .
            "<tg-emoji emoji-id='4904973211763999824'>🗣</tg-emoji> دلیل ریپورت رو انتخاب کن :\n";
    ...
    private function reasonSummaryKeyboard(): InlineKeyboardMarkup
    {
        return InlineKeyboardMarkup::make()
            ...
            ->addRow(
                InlineKeyboardButton::make('بازگشت', callback_data: 'reporter_rubika_menu', style: 'danger', icon_custom_emoji_id: '5352759161945867747')
            );
    }
    ...
    private function rubikaReasonKeyboard(): InlineKeyboardMarkup
    {
        ...
        $keyboard->addRow(InlineKeyboardButton::make('بازگشت', callback_data: 'reporter_rubika_menu', style: 'danger', icon_custom_emoji_id: '5352759161945867747'));
